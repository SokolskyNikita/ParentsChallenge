...
public class BotConfig {
    ...
    public static final String COMMANDS_TOKEN = "254621980:AAHymqRDmuaN_j9Ts_PTwf931n5WXSfDRKY";
    public static final String COMMANDS_USER = "HackParentsChallengeBot";
}
